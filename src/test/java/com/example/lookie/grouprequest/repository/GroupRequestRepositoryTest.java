...
class GroupRequestRepositoryTest {
    ...
    void createGroupRequest() {
        ...
        */
        ...
        GroupRequest groupRequest = GroupRequest.createGroupRequest(userResult, groupResult, department, questionAnswerList.toArray(EMPTY));
    ...
    void groupRequestList() {
        ...
        given
         */
        Member userMember1 = Member.createUserMember("abc@abc.com", "1234", "ABC", new Address("서울", "종로", "000006"));
        Member userMember2 = Member.createUserMember("hij@hij.com", "1234", "HIJ", new Address("서울", "종로", "000006"));
        ...
        GroupRequest groupRequest1 = GroupRequest.createGroupRequest(userResult1, groupResult, department, questionAnswerList.toArray(EMPTY));
        GroupRequest groupRequest2 = GroupRequest.createGroupRequest(userResult2, groupResult, department, questionAnswerList.toArray(EMPTY));
